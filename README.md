...
> - **Medical insurance underwriting / 医療保険 引受判定** (a `.ncproj` project) — the input side of the [ENISHI Life application simulator](https://modellogue.com/medical-underwriting/): three fields exist on screen only under a condition, each pinned by a `= _MASK_` / `<> _MASK_` constraint pair. The project ships its results — 13 pairwise cases (covered 125 / missed 0 / forbidden 13) and the 648-row decision table (90 valid, 558 forbidden). The **same specification also exists as a [NeoCEG cause-effect graph](https://neo-ceg.vercel.app/?file=https://sho1884.github.io/public-files/NeoCEG/Samples/OneMask-medical_insurance_underwriting_jp.nceg)**, so the two tools can be read side by side. 同一仕様を姉妹ツール NeoCEG でも公開しており、読み比べられます — [EN](https://neo-combi.vercel.app/?file=https://sho1884.github.io/public-files/NeoCombi/Samples/medical-underwriting-en.ncproj) · [JA](https://neo-combi.vercel.app/?file=https://sho1884.github.io/public-files/NeoCombi/Samples/medical-underwriting.ncproj)
...
> - **Admission fee / 入館料** — a decision table: inputs determine the fee, enforced by constraints (the fee is an expected-result factor). Also a **[NeoCEG cause-effect graph](https://neo-ceg.vercel.app/?file=https://sho1884.github.io/public-files/NeoCEG/Samples/Admissionfee_jp.nceg)** of the same specification — there the fee is five terminal effects, here it is a five-level factor. 同一仕様が NeoCEG にもあります — [EN](https://neo-combi.vercel.app/?file=https://sho1884.github.io/public-files/NeoCombi/Samples/admission-fee-en.ncombi) · [JA](https://neo-combi.vercel.app/?file=https://sho1884.github.io/public-files/NeoCombi/Samples/admission-fee.ncombi)
