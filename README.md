...
![Forbidden view — a 決済方法 × 支払回数 slice with red ✗ cells; the decision table below flags forbidden rows / 禁則ビュー — 決済方法×支払回数のスライスを赤い ✗ で表示。下段のデシジョンテーブルが禁則行を明示](Doc/asset/Screenshot_Forbidden.png)
