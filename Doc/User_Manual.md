...
![Forbidden view for the shopping-site example — a 決済方法 × 支払回数 slice with red X cells, and the decision table below flagging forbidden rows](asset/Screenshot_Forbidden.png)
